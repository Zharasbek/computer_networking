...
public:
    ...
    void createFrame(vector<Client>& clients, const Client &clientSender, const Client &clientReceiver,
     const std::string& message, int max_msg_size,
    const string &sender_port, const string &receiver_port);
    void printOutgoingQueue(const Client &client) const;

    Client* getNextHopClient(vector<Client>& clients, const Client &clientSender, const Client &clientReceiver);
